...
export GH_ORG=harikrongali

# Replace `[...]` with the base host accessible through NGINX Ingress
export BASE_HOST=local # e.g., $INGRESS_HOST.nip.io

export REGISTRY_SERVER=https://hub.docker.com/

# Replace `[...]` with the registry username
export REGISTRY_USER=harirongali637

# Replace `[...]` with the registry password
export REGISTRY_PASS=6659bb8f-3bf6-464f-ad10-35ac9846474e

# Replace `[...]` with the registry email
export REGISTRY_EMAIL=hari_rongali@intuit.com

# Replace `[...]` with the GitHub token
export GH_TOKEN=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

# Replace `[...]` with the GitHub email
export GH_EMAIL=hari_rongali@intuit.com
